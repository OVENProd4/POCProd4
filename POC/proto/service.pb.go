...
var file_proto_service_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x32, 0x46, 0x0a, 0x13, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2f, 0x0a, 0x0c, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f,
...
var file_proto_service_proto_depIdxs = []int32{
	0, // 0: proto.AuthenticateService.ValidateUser:input_type -> proto.Request
	1, // 1: proto.AuthenticateService.ValidateUser:output_type -> proto.Response
...
type AuthenticateServiceClient interface {
	ValidateUser(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *authenticateServiceClient) ValidateUser(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AuthenticateService/ValidateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticateServiceServer interface {
	ValidateUser(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedAuthenticateServiceServer) ValidateUser(context.Context, *Request) (*Response, error) {
...
func _AuthenticateService_ValidateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthenticateServiceServer).ValidateUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthenticateService/ValidateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticateServiceServer).ValidateUser(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AuthenticateService_ValidateUser_Handler,
		},
	},
